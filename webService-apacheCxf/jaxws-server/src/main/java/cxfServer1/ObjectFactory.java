 ...
 * generated in the cxfServer1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://ad/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://ad/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxfServer1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ad/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ad/", name = "sayResponse")
